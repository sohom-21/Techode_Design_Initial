export const features = [
  {
    ...
    text: "We build robust, scalable, and high-performance websites and applications tailored to your specific business needs. From e-commerce to enterprise software, we've got you covered.",
    button: {
  ...
  },
  {
    ...
    text: "Our design team creates intuitive and visually stunning user interfaces. We focus on user experience to ensure your customers love interacting with your digital products.",
    button: {
...
export const faq = [
  {
    ...
    answer:
      "The cost of a website varies depending on the complexity and features required. We offer custom quotes based on your specific needs, starting from basic landing pages to complex web applications.",
  },
  {
    id: "1",
    question: "How long does it take to build a website?",
    answer:
      "A standard website typically takes 2-4 weeks to complete, while more complex projects may take 8-12 weeks. We provide a detailed timeline before starting any project.",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    answer:
      "Absolutely! We can modernize your existing website with a fresh design, improved performance, and better user experience while keeping your brand identity intact.",
  },
  {
    id: "4",
    question: "Do you provide hosting and domain services?",
    answer:
      "We can help you set up hosting and domain registration, recommending the best providers for your specific needs.",
  },
  {
    id: "5",
    question: "What technologies do you use?",
    answer:
      "We specialize in modern web technologies including React, Next.js, Node.js, and Tailwind CSS, ensuring your project is built on a solid and scalable foundation.",
  },
  {
    id: "6",
    question: "Do you build mobile apps?",
    answer:
      "Yes, we design and develop mobile applications for both iOS and Android using cross-platform frameworks like React Native and Flutter.",
  },
  {
    id: "7",
    question: "What is your payment process?",
    answer:
      "We typically require a 50% deposit to start the project, with the remaining balance due upon completion and your final approval.",
  },
  {
    id: "8",
    question: "Will my website be mobile-friendly?",
    answer:
      "Yes, all our websites are designed to be fully responsive, ensuring they look and work great on all devices, from desktops to smartphones.",
  },
  {
    id: "9",
    question: "How do we communicate during the project?",
    answer:
      "We maintain open communication via email, Slack, or video calls, providing regular updates and gathering your feedback throughout the development process.",
  },
];
...
export const plans = [
  ...
  },
  {
    ...
    priceMonthly: 80000,
    priceYearly: 80000,
    caption: "For startups and enterprises",
    features: [
      "iOS & Android Apps",
      "Custom Backend API",
      "Push Notifications",
  ...
  },
  {
    ...
    priceMonthly: 120000,
    priceYearly: 120000,
    caption: "Complete digital solution",
    features: [
      "Website + Mobile App",
